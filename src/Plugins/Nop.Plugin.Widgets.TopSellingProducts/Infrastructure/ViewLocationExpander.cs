...
public class ViewLocationExpander : IViewLocationExpander
{
        ...
        IEnumerable<string> viewLocations)
    {
        ...
        {
            viewLocations = new[] {
                    $"/Plugins/Widgets.TopSellingProducts/Views/{{0}}.cshtml",
                }.Concat(viewLocations);
        }
        else
        {
            viewLocations = new[] {
                    //$"/Plugins/Widgets.TopSellingProducts/Views/Shared/{{0}}.cshtml",
                    //$"/Plugins/Widgets.TopSellingProducts/Views/{{1}}/{{0}}.cshtml",
                    $"/Plugins/Widgets.TopSellingProducts/Views/{{0}}.cshtml",
                }.Concat(viewLocations);

            //if (context.Values.TryGetValue(THEME_KEY, out var theme))
            //    viewLocations = new[] {
            //            $"/Plugins/Widgets.TopSellingProducts/Themes/{theme}/Views/Shared/{{0}}.cshtml",
            //            $"/Plugins/Widgets.TopSellingProducts/Themes/{theme}/Views/{{1}}/{{0}}.cshtml"
            //        }.Concat(viewLocations);
